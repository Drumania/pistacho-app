          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6 text-white">
              ...
              <div className="d-flex flex-wrap gap-3 mb-3">
                <a
                  href="https://drive.google.com/file/d/12vaxRCo7w08ZLHLUcO-nR03lkQU08aWM/view?usp=sharing"
                  target="_blank"
                ...
                <a
                  href="https://drive.google.com/file/d/1T953JLnlmUmg5zscjPduwjnYxYK1L9Qj/view?usp=sharing"
                  target="_blank"
                  rel="noopener noreferrer"
                >
